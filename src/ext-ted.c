...
static void do_copy(void)
{
    ...
    if (sel_active && sel_mode == SEL_MODE_CHAR) {
        ...
        sel_active = 0u;
        redraw_screen();
        draw_menu_bar("SELECTED COPIED TO CLIPBOARD");
        return;
    }
...
static void do_cut(void)
{
    ...
    if (sel_active && sel_mode == SEL_MODE_CHAR) {
        ...
        cur.col = c_from;
        redraw_screen();
        draw_menu_bar("SELECTED CUT TO CLIPBOARD");
        return;
    }
...
static void do_paste(void)
{
    ...
    if (clip_is_char) {
        ...
        redraw_screen();
        draw_menu_bar("CLIPBOARD PASTED");
        return;
    }
        ...
        if (!(keystates[0] & 1u)) {
            if (!handled_key) {
                ...
                /* --- F4: toggle view/edit mode --- */
                    ...
                    draw_menu_bar(view_mode ? "MODE View" : "MODE Edit");
