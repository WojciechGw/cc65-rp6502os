...
static const cmd_t commands[] = {
    ...
    { "cm",     "copy/move multiple files, wildcards allowed",
                "cp <source> <destination> (copy file)" NEWLINE
    ...
    { "bsave",  "save RAM/XRAM to binary file", 
                "bsave code.bin 0600 256 (save 256 bytes from RAM address 0x0600)" NEWLINE
    ...
    { "memr",   "show RAM from given address", 
                "memx 0x0600 512 (show 512 bytes of RAM from address 0x0600)" },
